...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow p-4">
            ...
            <asp:GridView ID="gvDepartman" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                          DataKeyNames="DepartmanID" OnSelectedIndexChanged="gvDepartman_SelectedIndexChanged" OnRowDeleting="gvDepartman_RowDeleting">
                <Columns>
